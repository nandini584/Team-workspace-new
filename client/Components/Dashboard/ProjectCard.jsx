    ...
    <div className="h-[18rem] bg-white rounded-2xl p-6 pr-6 pl-6 mr-10 mb-5 w-[17rem] px-2">
      <div className="flex flex-row justify-between mb-8">
        ...
        <img
          src={Profile}
          alt="profileimg"
          className="rounded-full w-[2.43rem]"
        />
      </div>
      <h1 className="font-jost font-bold text-xl mb-2">{props.projectname}</h1>
      <h1 className="font-inter font-regular text-xs opacity-50 mb-8">
      ...
      <div className="flex flex-row mt-3">
        <img
          src={Profile}
          alt="profileimg"
          className="rounded-full w-[2rem] mr-2"
        />
        <img
          src={Profile}
          alt="profileimg"
